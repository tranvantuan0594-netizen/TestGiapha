    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 px-4 py-4 border-b">
                ...
                {!collapsed && <span className="font-bold text-lg">Gia phả họ Trần Tịnh</span>}
            </div>
            ...
            {!collapsed && (
                <div className="border-t px-4 py-3">
                    <p className="text-xs text-muted-foreground leading-relaxed">
                        Để cập nhật <span className="font-semibold text-foreground">gia phả điện tử</span> <span> vui lòng liên hệ </span>
                        <br />
                        <span className="font-semibold text-foreground">📞 0983417861</span>
                        <br />
